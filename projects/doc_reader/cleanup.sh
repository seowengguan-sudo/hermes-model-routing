...
for old_file in /opt/data/projects/doc_reader/doc_reader_agent.py /opt/data/projects/doc_reader/doc_reader_desktop.py /opt/data/redaction_engine.py /opt/data/safe_format.py; do
    if [ -f "$old_file" ]; then
